            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col col-lg-10 col-xl-8">
                    <div class="card border-0">
                        <h2 class="lead fw-normal mb-0 text-center mt-3">Edit user</h2>
                                ...
                                <div class="mb-3 row row justify-content-end">
                                    <div class="col-sm-10">
                                        <div class="d-flex">
                                            ...
                                            <!-- link ke hapus_user.php dengan parameter id -->
                                            <a href="hapus_user.php?id=<?php echo $user_id; ?>" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </form>
